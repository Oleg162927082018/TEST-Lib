#ifndef PHANTOMJS_OUTPUT_COMPARATOR_H
#define PHANTOMJS_OUTPUT_COMPARATOR_H

#include "../../TTI/Common/itestcasetemplate.h"

class PhantomJsOutputComparator : public ITestOutputComparator
{
public:
...
#endif // PHANTOMJS_OUTPUT_COMPARATOR_H
